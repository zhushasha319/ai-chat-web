    ...
    <div class="bubble-wrap">
      <div class="bubble">
        ...
        <div class="tools" v-if="msg.role==='assistant' && !msg.meta?.streaming">
          ...
          <!-- 需要的话再加：重试/删除 -->
          <!-- <el-button text size="small" :icon="RefreshRight" class="tool-btn" @click="$emit('retry', msg.id)">重试</el-button> -->
          <!-- <el-button text size="small" :icon="Delete" class="tool-btn" @click="$emit('delete', msg.id)">删除</el-button> -->
        </div>
      </div>
    </div>
  </div>
